    ...
    <div class="container">
      ...
      <div class="button-box">
        <div class="grid-content bg-purple">
          <el-button type="primary" @click="toLogin" class="register_button"
            >LOGIN</el-button
          >
        </div>
        <div class="grid-content bg-purple-light">
          <el-button type="primary" @click="toRegister" class="login_button"
            >REGISTER</el-button
          >
        </div>
      </div>
      ...
      <div class="feature-container">
        <div class="feature_text">Features</div>
        <div>
          <el-col :span="12" style="margin-top: 3%">
            <div class="grid-content bg-purple">
              <el-row :gutter="20">
                ...
                <el-col :span="20">
                  <div class="grid-content bg-purple">
                    <div class="sub_feature_text">Instant Markdown Note</div>
                  </div>
                </el-col>
              </el-row>

              <div class="introduction">
                Support left-aligned typing with a wide range of fonts, sizes,
                and colors as well as a variety of auxiliary tool. Provide
                formatting for outlines and interactive list. Continuous page
                scroll inspires you to explore endless ideas.
              </div>
            </div>
          </el-col>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple" style="margin-top: 2%">
              <el-row :gutter="20">
                ...
                <el-col :span="20">
                  <div class="grid-content bg-purple">
                    <div class="sub_feature_text2">Note Management</div>
                  </div>
                </el-col>
              </el-row>

              <div class="introduction2">
                Notes can be created, deleted, and <br />sorted easily with
                minimal steps and a <br />user-friendly UI system. You can group
                <br />notes with customizable subjects and<br />
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-row :gutter="20">
                ...
                <el-col :span="20">
                  <div class="grid-content bg-purple">
                    <div class="sub_feature_text">Note Community</div>
                  </div>
                </el-col>
              </el-row>

              <div class="introduction">
                Note community is where users can upload their notes and view
                others notes. You can publish notes for the world to see in the
                note community through public note permissions. You will receive
                comments and likes from other users.
              </div>
            </div>
          </el-col>
      ...
      <div class="last_text" style="margin-top: 20%">
        <div class="same_align">
          ...
          <div style="margin-left: 1%">Note²</div>
        </div>
      </div>
      ...
      <div style="font-size: 9px">
        <div style="margin-top: 20px">
          <el-link
            :underline="false"
            href="https://github.com/Chen-Gary/note-squared"
          >
            https://github.com/Chen-Gary/note-squared</el-link
          >
        </div>
      </div>
  ...
  methods: {
    ...
    toLogin() {
      ...
      if (localStorage.elementToken) {
        this.$axios.get("/user/validate-token", {}).then((response) => {
...
.login_button {
  ...
  color: #367bf5;
  text-shadow: 0px 8px 16px rgba(54, 123, 245, 0.1),
