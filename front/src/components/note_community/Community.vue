  ...
  <div class="community-page">
    <div class="search_layout">
      <el-row :gutter="20">
        ...
        <el-col :span="13"
          ><div class="grid-content bg-purple">
            <span class="search_title" style="margin-right: 1%"> Search </span>
            <el-input
              v-model="keyword"
            ...
            ></el-input>
            <el-button class="note_refresh" type="text" @click="refreshNote"
...
export default {
  ...
  methods: {
          ...
          if (response.status === 200) {
            ...
            for (let i = 0; i < response.data.notes.length; i++) {
              ...
              note_list[i] = {
                ...
                thumb: obj.like,
                username: obj.publishDate.slice(0, 10),
                url: obj._id,
              };
            }
    ...
    show_all_note() {
      this.$axios
        .get("/admin/notelist/" + this.page.currentPage, {})
        .then((response) => {
          console.log("status:");
          console.log(response.data);
          let note_list = {};
