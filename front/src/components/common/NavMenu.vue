<template>
  <div class="nav-bar">
    ...
    >
      ...
      <el-menu-item>
        <el-button type="text" class="router_button" @click="to_personal_center"
          >Personal Center</el-button
        >
      </el-menu-item>

      <el-menu-item>
        <el-button type="text" class="router_button" @click="to_community"
          >Community</el-button
        >
      </el-menu-item>

      <li
        style="margin-right: 2%; float: right; outline: none; cursor: pointer"
      >
        <i
      ...
      <li
        ...
        "
      >
        <el-button type="text" class="router_button" @click="note_log_out">{{
          this.login_status
        }}</el-button>
      </li>
    </el-menu>
